...
<!-- TODO: 請在此補充專案描述，例如：
A UART controller implementation simulated using the Renode framework.
This project explores serial communication protocols and embedded hardware simulation. -->
